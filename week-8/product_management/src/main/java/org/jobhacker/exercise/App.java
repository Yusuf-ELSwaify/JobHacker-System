...
public class App 
{
    ...
    {
        List<Product> allProducts = addDummyData();

        getBookProducts(allProducts);
        System.out.println("======================================");
        getBookProductsPriceMoreThan100(allProducts);
        System.out.println("======================================");
        getToysProductsAndMakeDiscount10Percent(allProducts);
        System.out.println("======================================");
        getCheapestBook(allProducts);
        System.out.println("======================================");

    }
    public static void getBookProducts(List<Product> products)
    {
        List<Product> bookProducts = products.stream()
                .filter((product -> product.getCategory().equals("Books")))
                .toList();
        System.out.println("bookProducts = " + bookProducts);
    }
    public static void getBookProductsPriceMoreThan100(List<Product> products)
    {
        List<Product> bookProductsPriceMoreThan100 = products.stream()
                .filter((product -> product.getCategory().equals("Books") && product.getPrice() > 100))
                .toList();
        System.out.println("book products with price > 100 = " + bookProductsPriceMoreThan100);
    }
    public static void getToysProductsAndMakeDiscount10Percent(List<Product> products)
    {
        List<Product> toyProductsWithDiscount10Percent = products.stream()
                .filter((product -> product.getCategory().equals("Toys")))
                .map(product -> product.withPrice(product.getPrice() * 0.90))
                .toList();
        System.out.println("toy products with discount 10 % = " + toyProductsWithDiscount10Percent);
    }
    public static void getCheapestBook(List<Product> products)
    {
        ...
        cheapestBook.ifPresentOrElse(product -> System.out.println("cheapestBook = " + product),
